...
const ICON_GREY = Color(0xFF989898);
const RED = Color(0xFFEB1C1C);
const LIGHT_PINK = Color(0xFFDFC9DF);
const LIGHT_PINK_1 = Color(0xFFFBEFFC);
const DIVIDER_2 = Color(0xFFE4E4E4);
const WHITE_GREY = Color(0xFFF3F3F3);
const GREEN = Color(0xFF0DC500);
const DISABLED_COLOR = Color(0xFFEFEFEF);
const BLACK_6 = Color(0xFF505050);
const DARK_RED = Color(0xFFEB1C1C);
const BLACK4 = Color(0xFF545454);
const LIGHT_GRAY = Color(0xFF363636);
const GRAY = Color(0xFF707070);

const ORANGE = Color(0xFFF24023);
const LYNX_WHITE = Color(0xFFF7F7F7);
const WISP_PINK = Color(0xFFFEF5FE);
const OLD_LACE = Color(0xFFEDF9ED);
const LAVENDER_BLUSH = Color(0xFFFEEEEF);
const PINK_PEARL = Color(0xFFE5A9C9);
const BLACK_68 = Color(0x66505050);
...
const PALE_GOLD = Color(0xFFFFDF61);
